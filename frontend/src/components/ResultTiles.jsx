...
function ResultCards({id, user_ID, sighting_date}) {
  // const {data, setData} = useOutletContext();

  return (
    <>
    <Card style={{ margin: "1em", boxShadow: "-.1em 0 .4em rgb(73, 102, 102)", width: '90%', height: "40%" }}>
      <Card.Img style={{ height: "85%", width: "100%", objectFit: "cover"}} variant="top" src="https://i.insider.com/5db6fd7ddee019532146611b?width=700" />
